                <footer>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3 footer-list text-center">
                                    <p class="kratos-social-icons"><?php
                                         echo (!kratos_option('social_tweibo'))?'':'<a target="_blank" rel="nofollow" href="'.kratos_option('social_tweibo').'"><i class="fa fa-weixin"></i></a>';
                                    ...
                                    <p> © <?php echo date('Y'); ?> <a href="<?php echo get_option('home'); ?>"><?php bloginfo('name'); ?></a>. All Rights Reserved. <br> 
                                    <?php _e('本站已上线','moedog'); ?> <span id="span_dt_dt">Loading...</span>
                    ...
                    <div>asdfdddddddddddddddddd</div>
                </footer>
